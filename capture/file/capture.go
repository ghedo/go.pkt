// Provides packet capturing and injection on pcap dump files. Note that this
// doesn't use lippcap, but rather it implements its own dump file parsing. This
// makes it possible to support "append" mode, where packets are appended at the
// end of the file.
package file
